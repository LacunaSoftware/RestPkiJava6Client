...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2016-01-22T19:31:27.300-02:00")
@com.fasterxml.jackson.annotation.JsonIgnoreProperties(ignoreUnknown = true)
class XmlSignaturePostResponse   {
  ...
  public String toString()  {
    ...
    sb.append("class XmlSignaturePostResponse {\n");
